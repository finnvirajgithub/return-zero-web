  ...
  const projects = [
    {
      ...
      technologies: ["React", "Node.js", "Tripadvisor", "SEO"],
      results: [
    ...
    },
    {
      ...
      image: "/images/theislanders.png?height=300&width=400",
    ...
    // {
    //   id: 3,
    //   title: "TechStart Software Solution",
    //   category: "Software Development",
    //   description: "Custom CRM and project management system for a growing tech startup.",
    ...
    //   image: "/placeholder.svg?height=300&width=400",
    //   technologies: ["Next.js", "Stripe", "Reservation System"],
    //   results: [
    //     "40% increase in online reservations",
    //     "Reduced phone booking workload",
    ...
    // {
    //   id: 6,
    //   title: "Boutique Hotel Chain Management",
    //   category: "Hotel",
    //   description: "Multi-property management system with centralized booking and revenue optimization.",
    //   image: "/placeholder.svg?height=300&width=400",
    //   technologies: ["React", "Node.js", "Multi-tenant Architecture"],
    //   results: [
    //     "Unified management across 8 properties",
