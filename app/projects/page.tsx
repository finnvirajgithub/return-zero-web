...
export default function ProjectsPage() {
  ...
  const projects = [
    ...
    },
    {
      ...
      results: ["200% increase in tour bookings", "IT Consulting", "Streamlined booking process"],
      year: "2026",
    ...
    },
    {
      ...
      category: "Hotel",
      description:
        "Successfully integrated hotel with Booking.com, Airbnb, and Agoda, resulting in increased bookings.",
      image: "/images/sachi.png?height=300&width=400",
      link: "https://www.google.com/search?q=Sachi+Mountain+Villa+360%C2%B0&oq=sachi&gs_lcrp=EgZjaHJvbWUqCAgAEEUYJxg7MggIABBFGCcYOzIGCAEQRRg5MgoIAhAuGLEDGIAEMgcIAxAuGIAEMg0IBBAuGK8BGMcBGIAEMgcIBRAuGIAEMgcIBhAuGIAEMgcIBxAAGIAEMgcICBAuGIAEMgcICRAuGIAE0gEJMzU4MWowajE1qAIIsAIB8QUj3tG0p_4ErPEFI97RtKf-BKw&sourceid=chrome&ie=UTF-8",
